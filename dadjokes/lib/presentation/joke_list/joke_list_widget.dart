...
import 'package:dad_jokes_flutter/domain/joke_list/bloc/joke_list_bloc.dart';
...
class JokeListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<JokeListBloc, UIState<List<JokeEntity>>>(
  ...
  Widget _buildListView(BuildContext context, List<JokeEntity> list) {
